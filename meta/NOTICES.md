...
| 58 | 2026-09-25 | | 1.6.0 step 3f (DEF-99: a move out of `fixed` storage holding an owning value compiled and faulted — the library listener's finding; the move refuses as the copy does) | no language change (D-287's reason, asked of the write a move makes); a REFUSAL ADDED as F9 announced; every ladder row unchanged except the emission's text where the checker grew; the manifest RE-RECORDED for the checker's new function |
