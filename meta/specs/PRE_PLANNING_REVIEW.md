...
| **Generics** | `SPEC_GAPS` §3 resolves *declaration* syntax only | Nested generics, implicit call syntax, the `Type` keyword, monomorphization strategy — all unspecified. |
...
| **Streams / IO** | — | Needed for the driver and diagnostics. |
