...
**DEF-38 — OPEN (owner: the user, as S-59 in §2e; then the `src/` writer;
found 2026-09-10 by 1.5.4b step 4b, on `044a04d`) — a `simd` integer lane's
