...
| **B-5** | D-162 | **NIKOS: specify or defer.** A named 1.4 deliverable with zero specification (one flag, one manifest example, one sentence). Either write a NIKOS reference (domains, checks, port-vs-rebuild from the prototype, relationship to Astrée) or strike it from the 1.4 line and schedule separately. | 1.5 | verification F7 |
...
**The research began at the 1.4.0 open** — the user started the
deep-research reports; the briefs (this review's, plus the 1.5-prep set)
are externalized in `meta/roadmap/RESEARCH_BRIEFS.md`.
...
5. **C-14…C-17 before 1.5 anything**, and **C-19 answered before 1.5 exits**.
