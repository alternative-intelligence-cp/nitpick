 ...
 */
uint16_t npk_pack_nyte(int8_t n0, int8_t n1, int8_t n2, int8_t n3, int8_t n4);
 ...
 */
void npk_unpack_nyte(uint16_t packed, int8_t* n0, int8_t* n1, int8_t* n2, int8_t* n3, int8_t* n4);
...
int8_t npk_lerp_component(int32_t a, int32_t b, int32_t t);
