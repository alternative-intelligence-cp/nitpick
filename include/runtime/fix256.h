 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_sub(aria_fix256_t a, aria_fix256_t b);
 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_mul(aria_fix256_t a, aria_fix256_t b);
 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_div(aria_fix256_t a, aria_fix256_t b);
 ...
 */
ARIA_DEVICE_HOST int aria_fix256_cmp(aria_fix256_t a, aria_fix256_t b);

/**
 * Test equality of two Q128.128 fixed-point numbers
 * Returns: true if a == b
 */
ARIA_DEVICE_HOST int aria_fix256_eq(aria_fix256_t a, aria_fix256_t b);

/**
 * Test if a < b
 */
ARIA_DEVICE_HOST int aria_fix256_lt(aria_fix256_t a, aria_fix256_t b);

/**
 * Test if a <= b
 */
ARIA_DEVICE_HOST int aria_fix256_le(aria_fix256_t a, aria_fix256_t b);

/**
 * Test if a > b
 */
ARIA_DEVICE_HOST int aria_fix256_gt(aria_fix256_t a, aria_fix256_t b);

/**
 * Test if a >= b
 */
ARIA_DEVICE_HOST int aria_fix256_ge(aria_fix256_t a, aria_fix256_t b);
 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_from_i32(int32_t val);

/**
 * Convert 64-bit signed integer to Q128.128 fixed-point
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_from_i64(int64_t val);

/**
 * Convert Q128.128 fixed-point to 32-bit signed integer (truncates fractional part)
 */
ARIA_DEVICE_HOST int32_t aria_fix256_to_i32(aria_fix256_t val);

/**
 * Convert Q128.128 fixed-point to 64-bit signed integer (truncates fractional part)
 */
ARIA_DEVICE_HOST int64_t aria_fix256_to_i64(aria_fix256_t val);
 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_from_f32(float val);
 ...
 */
ARIA_DEVICE_HOST aria_fix256_t aria_fix256_from_f64(double val);
 ...
 */
ARIA_DEVICE_HOST float aria_fix256_to_f32(aria_fix256_t val);

/**
 * Convert Q128.128 fixed-point to 64-bit double (APPROXIMATE - for display only!)
 * WARNING: Loss of precision - use only for human-readable output
 */
ARIA_DEVICE_HOST double aria_fix256_to_f64(aria_fix256_t val);
