 ...
 * @return AriaString pointer with decimal representation
 */
AriaString* npk_format_int2048(const npk_int2048_t* val);
 ...
 * @return AriaString pointer with decimal representation
 */
AriaString* npk_format_uint2048(const npk_int2048_t* val);
 ...
 * @return AriaString pointer with decimal representation
 */
AriaString* npk_format_int4096(const npk_int4096_t* val);
 ...
 * @return AriaString pointer with decimal representation
 */
AriaString* npk_format_uint4096(const npk_int4096_t* val);
