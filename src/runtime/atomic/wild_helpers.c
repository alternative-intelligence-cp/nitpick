 ...
 *    globals and use npk_wild_to_int64 / npk_int64_to_wild to convert.
 *
 * 2. The Aria borrow checker requires wild pointer locals to be passed to a
 *    void(wild T*)-only extern before scope exit.  npk_borrow_wild acts as
