...
Aria provides two **quantum-inspired generic types** that maintain **two hypotheses simultaneously** with a confidence gradient:
...
for reading in sensor_readings {
    altitude.qif((q == reading), c += sign(q - 102));  // Evidence toward closer value
}
...
| AI reasoning | `Q9<T>` | Mirrors human belief evolution |
