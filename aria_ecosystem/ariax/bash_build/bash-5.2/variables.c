...
#  endif
  ...
  /* AriaX: Set up six-stream I/O environment variables */
  bind_variable ("STDDBG", "/dev/fd/3", 0);   /* Debug output stream */
  bind_variable ("STDDATI", "/dev/fd/4", 0);  /* Data input stream */
  bind_variable ("STDDATO", "/dev/fd/5", 0);  /* Data output stream */
