...
private:
        ...
        // AriaX: Expanded to 6 streams (stdin, stdout, stderr, stddbg, stddati, stddato)
        // these 6 are placeholder elements for FDs being mapped to 0-5 later
        // we preallocate this here so that the child setup function doesn't do any
        // allocations
        std::vector<std::pair<int,int>> m_fd_map{{-1, 0}, {-1, 1}, {-1, 2}, {-1, 3}, {-1, 4}, {-1, 5}};
