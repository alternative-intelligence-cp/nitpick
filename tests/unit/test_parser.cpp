...
TEST_CASE(parser_var_decl_simple) {
    ...
    ASSERT_EQ(varDecl->typeNode->toString(), "int8", "Type should be int8");
...
TEST_CASE(parser_var_decl_string) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(stmt);
    ASSERT(varDecl != nullptr, "Cast to VarDeclStmt should succeed");
    ASSERT_EQ(varDecl->typeNode->toString(), "string", "Type should be string");
...
TEST_CASE(parser_func_no_params) {
    ...
    ASSERT_EQ(funcDecl->returnType->toString(), "string", "Return type should be string");
...
TEST_CASE(parser_func_one_param) {
    ...
    ASSERT_EQ(funcDecl->returnType->toString(), "int8", "Return type should be int8");
    ...
    ASSERT_EQ(param->typeNode->toString(), "int8", "Parameter type should be int8");
...
TEST_CASE(parser_func_multiple_params) {
    ...
    ASSERT_EQ(funcDecl->returnType->toString(), "int32", "Return type should be int32");
    ...
    ASSERT_EQ(param1->typeNode->toString(), "int32", "First parameter type should be int32");
...
TEST_CASE(parser_type_simple_bool) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(stmt);
    ASSERT(varDecl != nullptr, "Cast to VarDeclStmt should succeed");
    ASSERT_EQ(varDecl->typeNode->toString(), "bool", "Type should be bool");
...
TEST_CASE(parser_type_int32) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(stmt);
    ASSERT(varDecl != nullptr, "Cast to VarDeclStmt should succeed");
    ASSERT_EQ(varDecl->typeNode->toString(), "int32", "Type should be int32");
...
TEST_CASE(parser_type_int64) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(stmt);
    ASSERT(varDecl != nullptr, "Cast to VarDeclStmt should succeed");
    ASSERT_EQ(varDecl->typeNode->toString(), "int64", "Type should be int64");
...
TEST_CASE(parser_type_flt32) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(stmt);
    ASSERT(varDecl != nullptr, "Cast to VarDeclStmt should succeed");
    ASSERT_EQ(varDecl->typeNode->toString(), "flt32", "Type should be flt32");
...
TEST_CASE(parser_type_multiple_vars_same_type) {
    ...
    ASSERT_EQ(var1->typeNode->toString(), "int8", "First type should be int8");
    ASSERT_EQ(var2->typeNode->toString(), "int8", "Second type should be int8");
    ASSERT_EQ(var3->typeNode->toString(), "int8", "Third type should be int8");
...
TEST_CASE(parser_type_mixed_types) {
    ...
    ASSERT_EQ(var1->typeNode->toString(), "int8", "First type should be int8");
    ASSERT_EQ(var2->typeNode->toString(), "string", "Second type should be string");
    ASSERT_EQ(var3->typeNode->toString(), "bool", "Third type should be bool");
}
...
TEST_CASE(parser_type_uint8) {
    ...
    ASSERT_EQ(varDecl->typeNode->toString(), "uint8", "Type should be uint8");
}
...
TEST_CASE(parser_type_uint32) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "uint32", "Type should be uint32");
}
...
TEST_CASE(parser_type_uint64) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "uint64", "Type should be uint64");
}
...
TEST_CASE(parser_type_flt64) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "flt64", "Type should be flt64");
}
...
TEST_CASE(parser_type_tbb8) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "tbb8", "Type should be tbb8");
}
...
TEST_CASE(parser_type_tbb32) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "tbb32", "Type should be tbb32");
}
...
TEST_CASE(parser_type_obj) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "obj", "Type should be obj");
}
...
TEST_CASE(parser_type_dyn) {
    ...
    auto varDecl = std::dynamic_pointer_cast<VarDeclStmt>(prog->declarations[0]);
    ASSERT(varDecl != nullptr, "Should be VarDeclStmt");
    ASSERT_EQ(varDecl->typeNode->toString(), "dyn", "Type should be dyn");
}
...
TEST_CASE(parser_type_func_params_varied) {
    ...
    ASSERT_EQ(param1->typeNode->toString(), "string", "First param should be string");
    ASSERT_EQ(param2->typeNode->toString(), "bool", "Second param should be bool");
    ASSERT_EQ(param3->typeNode->toString(), "flt32", "Third param should be flt32");
}
...
TEST_CASE(parser_type_func_return_bool) {
    ...
    auto funcDecl = std::dynamic_pointer_cast<FuncDeclStmt>(prog->declarations[0]);
    ASSERT(funcDecl != nullptr, "Should be FuncDeclStmt");
    ASSERT_EQ(funcDecl->returnType->toString(), "bool", "Return type should be bool");
}
...
TEST_CASE(parser_type_func_complex) {
    ...
    auto funcDecl = std::dynamic_pointer_cast<FuncDeclStmt>(prog->declarations[0]);
    ASSERT(funcDecl != nullptr, "Should be FuncDeclStmt");
    ASSERT_EQ(funcDecl->returnType->toString(), "flt64", "Return type should be flt64");
    ASSERT_EQ(funcDecl->parameters.size(), 3, "Should have 3 parameters");
}
