...
TEST(xor_self_zeros) {
    ...
    npk_asm_mov_r64_imm64(a, REG_RAX, 0xDEADBEEF);
    npk_asm_xor_r64_r64(a, REG_RAX, REG_RAX);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 0);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(and_or_not) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_mov_r64_imm64(a, REG_RAX, 0xFF);
    npk_asm_mov_r64_imm64(a, REG_RCX, 0x0F);
    npk_asm_and_r64_r64(a, REG_RAX, REG_RCX);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 0x0F);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(or_bits) {
    Assembler* a = npk_asm_create();
    npk_asm_mov_r64_imm64(a, REG_RAX, 0xF0);
    npk_asm_mov_r64_imm64(a, REG_RCX, 0x0F);
    npk_asm_or_r64_r64(a, REG_RAX, REG_RCX);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 0xFF);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(neg_value) {
    ...
    npk_asm_neg_r64(a, REG_RAX);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), -42);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(shl_shr_sar) {
    // 1 << 4 = 16
    Assembler* a = npk_asm_create();
    npk_asm_mov_r64_imm64(a, REG_RAX, 1);
    npk_asm_shl_r64_imm8(a, REG_RAX, 4);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 16);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(add_imm32) {
    ...
    npk_asm_add_r64_imm32(a, REG_RAX, 42);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 142);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(sub_imm32) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_mov_r64_imm64(a, REG_RAX, 100);
    npk_asm_sub_r64_imm32(a, REG_RAX, 42);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 58);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(cmp_imm32_je) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_eq = npk_asm_new_label(a);
    int lbl_end = npk_asm_new_label(a);
    npk_asm_mov_r64_r64(a, REG_RAX, REG_RDI);
    npk_asm_cmp_r64_imm32(a, REG_RAX, 10);
    npk_asm_je(a, lbl_eq);
    npk_asm_mov_r64_imm64(a, REG_RAX, 0);
    npk_asm_jmp(a, lbl_end);
    npk_asm_bind_label(a, lbl_eq);
    npk_asm_mov_r64_imm64(a, REG_RAX, 1);
    npk_asm_bind_label(a, lbl_end);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute_i64(&g, 10), 1);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(jl_jg_signed) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_neg = npk_asm_new_label(a);
    int lbl_pos = npk_asm_new_label(a);
    int lbl_end = npk_asm_new_label(a);

    npk_asm_cmp_r64_imm32(a, REG_RDI, 0);
    npk_asm_jl(a, lbl_neg);
    npk_asm_jg(a, lbl_pos);
    npk_asm_mov_r64_imm64(a, REG_RAX, 0);
    npk_asm_jmp(a, lbl_end);

    npk_asm_bind_label(a, lbl_neg);
    npk_asm_mov_r64_imm64(a, REG_RAX, -1);
    npk_asm_jmp(a, lbl_end);

    npk_asm_bind_label(a, lbl_pos);
    npk_asm_mov_r64_imm64(a, REG_RAX, 1);
    ...
    ASSERT_EQ(npk_asm_execute_i64(&g, -5), -1);
    // Additional checks inline
    int64_t r0 = npk_asm_execute_i64(&g, 0);
    int64_t r1 = npk_asm_execute_i64(&g, 42);
    if (r0 != 0 || r1 != 1) {
...
TEST(mem_load_store) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_prologue(a, 16);
    npk_asm_store_local(a, 8, REG_RDI);       // [RBP-8] = arg1
    npk_asm_load_local(a, REG_RAX, 8);         // RAX = [RBP-8]
    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute_i64(&g, 12345), 12345);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(mem_base_offset) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_prologue(a, 16);
    npk_asm_mov_r64_imm64(a, REG_RCX, 99);
    npk_asm_mov_mem_r64(a, REG_RBP, -8, REG_RCX);
    npk_asm_mov_r64_mem(a, REG_RAX, REG_RBP, -8);
    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 99);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(lea_address) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_lea_r64_mem(a, REG_RAX, REG_RDI, 10);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    // Pass 100, should get 110
    ASSERT_EQ(npk_asm_execute_i64(&g, 100), 110);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(call_label_internal) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_helper = npk_asm_new_label(a);

    // Main: call helper, then return
    npk_asm_call_label(a, lbl_helper);
    npk_asm_ret(a);

    // Helper function
    npk_asm_bind_label(a, lbl_helper);
    npk_asm_mov_r64_imm64(a, REG_RAX, 42);
    npk_asm_ret(a);
...
TEST(call_indirect) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_add = npk_asm_new_label(a);

    // Main: already have args in RDI, RSI. Call add helper.
    npk_asm_call_label(a, lbl_add);
    npk_asm_ret(a);

    // add(a,b): return a+b
    npk_asm_bind_label(a, lbl_add);
    npk_asm_mov_r64_r64(a, REG_RAX, REG_RDI);
    npk_asm_add_r64_r64(a, REG_RAX, REG_RSI);
    npk_asm_ret(a);

    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute_i64_i64(&g, 30, 12), 42);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(fp_add_double) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_addsd(a, REG_XMM0, REG_XMM0);  // xmm0 = xmm0 + xmm0
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_NEAR(npk_asm_execute_f64_f64(&g, 3.14), 6.28, 0.001);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(fp_mul_double) {
    ...
    npk_asm_mov_r64_imm64(a, REG_RAX, 0x4004000000000000LL);
    npk_asm_mov_mem_r64(a, REG_RBP, -8, REG_RAX);

    // Load 2.5 into XMM1
    npk_asm_movsd_xmm_mem(a, REG_XMM1, REG_RBP, -8);

    // Multiply: XMM0 *= XMM1
    npk_asm_mulsd(a, REG_XMM0, REG_XMM1);

    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_NEAR(npk_asm_execute_f64_f64(&g, 4.0), 10.0, 0.001);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(fp_sub_div) {
    ...
    npk_asm_mov_r64_imm64(a, REG_RAX, 0x3FF0000000000000LL);
    npk_asm_mov_mem_r64(a, REG_RBP, -8, REG_RAX);
    npk_asm_movsd_xmm_mem(a, REG_XMM1, REG_RBP, -8);
    npk_asm_subsd(a, REG_XMM0, REG_XMM1);  // xmm0 = arg - 1.0

    // Store 2.0 at [RBP-8]: 0x4000000000000000
    npk_asm_mov_r64_imm64(a, REG_RAX, 0x4000000000000000LL);
    npk_asm_mov_mem_r64(a, REG_RBP, -8, REG_RAX);
    npk_asm_movsd_xmm_mem(a, REG_XMM1, REG_RBP, -8);
    npk_asm_divsd(a, REG_XMM0, REG_XMM1);  // xmm0 = (arg-1) / 2

    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    // (11.0 - 1.0) / 2.0 = 5.0
    ASSERT_NEAR(npk_asm_execute_f64_f64(&g, 11.0), 5.0, 0.001);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(fp_ucomisd_branch) {
    ...
    npk_asm_ucomisd(a, REG_XMM0, REG_XMM1);
    npk_asm_ja(a, lbl_pos);
    ...
    a = npk_asm_create();
    lbl_pos = npk_asm_new_label(a);
    lbl_end = npk_asm_new_label(a);

    // Use integer comparison instead to verify JA works
    // Store 10 in RAX, 5 in RCX, CMP RAX, RCX, JA pos → return 1
    npk_asm_mov_r64_imm64(a, REG_RAX, 10);
    npk_asm_mov_r64_imm64(a, REG_RCX, 5);
    npk_asm_cmp_r64_r64(a, REG_RAX, REG_RCX);
    npk_asm_ja(a, lbl_pos);
    npk_asm_mov_r64_imm64(a, REG_RAX, 0);
    npk_asm_jmp(a, lbl_end);
    npk_asm_bind_label(a, lbl_pos);
    ...
    g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 1);  // 10 > 5 unsigned = true
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(fp_movsd_store_load) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_prologue(a, 16);
    npk_asm_movsd_mem_xmm(a, REG_RBP, -8, REG_XMM0);
    // Zero out XMM0
    npk_asm_movsd_xmm_xmm(a, REG_XMM1, REG_XMM0);  // save
    npk_asm_xor_r64_r64(a, REG_RAX, REG_RAX);        // zero RAX
    npk_asm_mov_mem_r64(a, REG_RBP, -16, REG_RAX);   // zero [RBP-16]
    npk_asm_movsd_xmm_mem(a, REG_XMM0, REG_RBP, -16); // XMM0 = 0.0
    // Reload from stored location
    npk_asm_movsd_xmm_mem(a, REG_XMM0, REG_RBP, -8);
    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_NEAR(npk_asm_execute_f64_f64(&g, 7.77), 7.77, 0.001);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(simd_addps) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_prologue(a, 64);  // Need 16-byte aligned space
    ...
    npk_asm_mov_r64_imm64(a, REG_RAX, 0x400000003F800000LL);
    npk_asm_mov_mem_r64(a, REG_RBP, -32, REG_RAX);
    npk_asm_mov_r64_imm64(a, REG_RAX, 0x4080000040400000LL);
    npk_asm_mov_mem_r64(a, REG_RBP, -24, REG_RAX);
    ...
    npk_asm_movaps_xmm_mem(a, REG_XMM0, REG_RBP, -32);
    npk_asm_addps(a, REG_XMM0, REG_XMM0);  // double each: {2.0, 4.0, 6.0, 8.0}
    npk_asm_movaps_mem_xmm(a, REG_RBP, -32, REG_XMM0);

    // Read back first float (should be 2.0f = 0x40000000)
    npk_asm_mov_r64_mem(a, REG_RAX, REG_RBP, -32);
    // RAX now has the low 64 bits: [float0, float1]
    // Mask to get just float0 (lower 32 bits)
    npk_asm_mov_r64_imm64(a, REG_RCX, 0xFFFFFFFF);
    npk_asm_and_r64_r64(a, REG_RAX, REG_RCX);

    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);

    int64_t result = npk_asm_execute(&g);
    // 2.0f = 0x40000000
...
TEST(multi_locals) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_prologue(a, 32);

    // Store arg1 (RDI) at [RBP-8], arg2 (RSI) at [RBP-16]
    npk_asm_store_local(a, 8, REG_RDI);
    npk_asm_store_local(a, 16, REG_RSI);

    // Load them back and add
    npk_asm_load_local(a, REG_RAX, 8);
    npk_asm_load_local(a, REG_RCX, 16);
    npk_asm_add_r64_r64(a, REG_RAX, REG_RCX);

    // Store result at [RBP-24], load back
    npk_asm_store_local(a, 24, REG_RAX);
    npk_asm_load_local(a, REG_RAX, 24);

    npk_asm_epilogue(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute_i64_i64(&g, 17, 25), 42);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(factorial_loop) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_loop = npk_asm_new_label(a);
    int lbl_done = npk_asm_new_label(a);

    // RAX = result = 1, RDI = n (arg1)
    npk_asm_mov_r64_imm64(a, REG_RAX, 1);

    npk_asm_bind_label(a, lbl_loop);
    npk_asm_cmp_r64_imm32(a, REG_RDI, 1);
    npk_asm_jle(a, lbl_done);

    npk_asm_imul_r64_r64(a, REG_RAX, REG_RDI);
    npk_asm_sub_r64_imm32(a, REG_RDI, 1);
    npk_asm_jmp(a, lbl_loop);

    npk_asm_bind_label(a, lbl_done);
    npk_asm_ret(a);

    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute_i64(&g, 10), 3628800);  // 10!
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(extended_regs) {
    ...
    Assembler* a = npk_asm_create();
    npk_asm_mov_r64_imm64(a, REG_R12, 100);
    npk_asm_mov_r64_imm64(a, REG_R13, 200);
    npk_asm_mov_r64_r64(a, REG_RAX, REG_R12);
    npk_asm_add_r64_r64(a, REG_RAX, REG_R13);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 300);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
