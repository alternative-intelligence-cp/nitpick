...
TEST(peephole_mov_zero_to_xor) {
    ...
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0);
...
TEST(peephole_identity_mov) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 77);
    npk_asm_mov_r64_r64(a, (AsmRegister)v0, (AsmRegister)v0); // identity → NOP
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 77);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(peephole_add_zero_elim) {
    ...
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 0); // → NOP
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
...
TEST(peephole_shift_zero_elim) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 99);
    npk_asm_shl_r64_imm8(a, (AsmRegister)v0, 0); // → NOP
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
...
TEST(peephole_dead_store_elim) {
    ...
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 20); // kills first MOV
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 20);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(peephole_strength_reduction) {
    ...
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 5);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v1, 8);
    npk_asm_imul_r64_r64(a, (AsmRegister)v0, (AsmRegister)v1);
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 40);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(peephole_stats_available) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0);  // → XOR (1 elimination)
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 0);   // → NOP (1 elimination)
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    PeepholeStats ps = npk_asm_peephole_stats(a);
...
TEST(isel_mov_imm64_narrow) {
    ...
    InsnSelStats is = npk_asm_insn_sel_stats(a);
...
TEST(isel_mov_large_imm64) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0x100000000LL);
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 0x100000000LL);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(isel_add_one_inc) {
    ...
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 99);
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 1); // → INC
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 100);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(isel_sub_one_dec) {
    ...
    npk_asm_sub_r64_imm32(a, (AsmRegister)v0, 1); // → DEC
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 99);
...
TEST(isel_add_imm8_form) {
    ...
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 100);
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 42); // → imm8 form
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
...
TEST(isel_cmp_zero_test) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_zero = npk_asm_new_label(a);
    int lbl_end  = npk_asm_new_label(a);
    int v0 = npk_asm_vreg_new_gpr(a);

    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0);
    npk_asm_cmp_r64_imm32(a, (AsmRegister)v0, 0); // → TEST v0, v0
    npk_asm_je(a, lbl_zero);
    // Not zero path
    npk_asm_mov_r64_imm64(a, REG_RAX, 0);
    npk_asm_jmp(a, lbl_end);
    // Zero path
    npk_asm_bind_label(a, lbl_zero);
...
TEST(isel_sub_imm8_form) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 200);
    npk_asm_sub_r64_imm32(a, (AsmRegister)v0, 50); // → imm8 form
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 150);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(isel_stats_tracking) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 10);  // narrowed
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 1);    // → INC
    npk_asm_sub_r64_imm32(a, (AsmRegister)v0, 1);    // → DEC
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 42);   // → imm8
    npk_asm_cmp_r64_imm32(a, (AsmRegister)v0, 0);    // → TEST
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    InsnSelStats is = npk_asm_insn_sel_stats(a);
...
TEST(arch_get_current) {
    ...
    ASSERT_EQ((int)npk_asm_get_arch(), (int)ASM_ARCH_X86_64);
}

TEST(arch_x86_64_supported) {
    ASSERT_TRUE(npk_asm_arch_supported(ASM_ARCH_X86_64));
}

TEST(arch_aarch64_not_supported) {
    // AArch64 is not yet supported on this x86-64 build
    ASSERT_TRUE(!npk_asm_arch_supported(ASM_ARCH_AARCH64));
}
...
TEST(combined_peephole_isel_loop) {
    ...
    Assembler* a = npk_asm_create();
    int lbl_top  = npk_asm_new_label(a);
    int lbl_done = npk_asm_new_label(a);
    int v0 = npk_asm_vreg_new_gpr(a);
    int v1 = npk_asm_vreg_new_gpr(a);

    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0);   // → XOR (peephole)
    npk_asm_mov_r64_imm64(a, (AsmRegister)v1, 10);   // → MOV r32, 10 (isel)
    npk_asm_bind_label(a, lbl_top);
    npk_asm_cmp_r64_r64(a, (AsmRegister)v0, (AsmRegister)v1);
    npk_asm_jge(a, lbl_done);
    npk_asm_add_r64_imm32(a, (AsmRegister)v0, 1);    // → INC (isel)
    npk_asm_jmp(a, lbl_top);
    npk_asm_bind_label(a, lbl_done);
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);

    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 10);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(combined_strength_reduce_add) {
    ...
    int v0 = npk_asm_vreg_new_gpr(a);
    int v1 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 7);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v1, 16);
    npk_asm_imul_r64_r64(a, (AsmRegister)v0, (AsmRegister)v1);
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 112);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
...
TEST(combined_maxval_u32) {
    ...
    Assembler* a = npk_asm_create();
    int v0 = npk_asm_vreg_new_gpr(a);
    npk_asm_mov_r64_imm64(a, (AsmRegister)v0, 0xFFFFFFFF);
    npk_asm_mov_r64_r64(a, REG_RAX, (AsmRegister)v0);
    npk_asm_ret(a);
    WildXGuard g = npk_asm_finalize(a);
    ASSERT_EQ(npk_asm_execute(&g), 0xFFFFFFFF);
    npk_free_exec(&g);
    npk_asm_destroy(a);
}
