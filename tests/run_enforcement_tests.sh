...
echo "Expected: ERROR"
./build/npkc tests/test_enforcement_bad1.npk 2>&1 | grep "Cannot access .value" && echo "✅ PASS: Correctly rejected" || echo "❌ FAIL: Should have been rejected"
echo ""
...
echo "Expected: ERROR"
./build/npkc tests/test_enforcement_bad2.npk 2>&1 | grep "Cannot modify .is_error" && echo "✅ PASS: Correctly rejected" || echo "❌ FAIL: Should have been rejected"
echo ""

# Test 3: Phase 1 - Should PASS (proper .is_error check)
echo "TEST 3: Phase 1 - Accessing .value WITH .is_error check"
echo "Expected: SUCCESS"
./build/npkc tests/test_enforcement_good1.npk > /dev/null 2>&1 && echo "✅ PASS: Compiled successfully" || echo "❌ FAIL: Should have compiled"
echo ""
...
./build/npkc tests/test_enforcement_good2.npk 2>&1 | grep "Cannot modify .is_error" && echo "❌ FAIL: Should have allowed modification" || echo "✅ PASS: Allowed modification with wild"
echo ""
